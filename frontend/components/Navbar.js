export default {
    ...
    template: `    
        <nav class="navbar navbar-expand-lg navbar-light bg-light shadow-sm p-2">
            <router-link to="/logout" class="navbar-brand fw-bold fs-4 ms-3">Homebuddy</router-link>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <router-link to="/logout" class="nav-link text-danger fw-bold">Logout</router-link>
                    </li>
                </ul>
            </div>
        </nav>
